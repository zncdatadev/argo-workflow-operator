...
# zncdata.net/argo-workflow-operator-bundle:$VERSION and zncdata.net/argo-workflow-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= $(RETISTRY)/argo-workflow-operator
...
IMG ?= $(RETISTRY)/argo-workflow-operator:$(VERSION)
